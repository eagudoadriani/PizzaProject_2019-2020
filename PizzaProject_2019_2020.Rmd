...
ggsave("ComparationAlgaeCover_boot.png", width = 20, height = 20, units = "cm", dpi = 300)
...
### Procedural Control of warm season
...
ggsave("WarmProceduralControl.png", width = 14, height = 12, units = "cm", dpi = 300)
```
