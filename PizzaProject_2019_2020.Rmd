...
```{r}
#Loading data
AlgaeWeight_Cold2019<-read.csv(file="AlgaeWeight_Cold2020.csv") # I changed this to 'AlgaeWeight_Cold2020.csv' from 'AlgaeWeight_Cold2019.csv' since that file did not exist
...
write.csv(mean_AlgaeWeight_Cold2019_boot, file="Tables.csv", sheetName = "Cold_WeightBoot",  col.names = TRUE, row.names = TRUE, append = FALSE)

write.csv(mean_AlgaeWeight_Warm2020_boot, file="Tables.csv", sheetName = "Warm_WeightBoot",  col.names = TRUE, row.names = TRUE, append = TRUE)

write.csv(summary_cold_glm, file="Tables.csv", sheetName = "cold_glm",  col.names = TRUE, row.names = TRUE, append = TRUE)

write.csv(summary_warm_glm 
, file="Tables.csv", sheetName = "warm_glm",  col.names = TRUE, row.names = TRUE, append = TRUE)
