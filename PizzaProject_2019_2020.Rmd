...
AlgaeWeight_bootCI<-ggarrange(cold_boot_plot, warm_boot_plot, nrow=1, common.legend = TRUE, labels = c("A", "B"),legend="bottom")

png("AlgaeWeight_bootCI_AB.png", width=15, height=10, units="cm", res=300)
print(AlgaeWeight_bootCI)
dev.off()
```
